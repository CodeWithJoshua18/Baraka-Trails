...
Experience: Peak wildlife, perfect weather, but higher rates.`,
  ...
  return (
    <div className="relative min-h-screen text-black bg-[#FAF7F2] overflow-x-hidden">
      ...
      {/* UPDATED QUICK LINKS - Glassmorphic Styling */}
      <section
      ...
      >
        <div className="absolute inset-0 bg-black/60 z-0"></div>
        <div className="relative z-[1] max-w-5xl mx-auto space-y-12">
          <motion.h2
            className="text-3xl md:text-4xl font-bold text-center !text-amber-300 drop-shadow-lg"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
          >
            More Ways To Experience Tanzania
          </motion.h2>
          ...
          <div className="space-y-10">
            ...
            >
              ...
              <p className="text-white leading-relaxed mb-4 drop-shadow-md">
              ...
              <div className="space-y-4">
                <div>
                  <h5 className="font-semibold text-lg !text-white mb-2">1. Colors to Wear</h5>
                ...
                <div>
                  <h5 className="font-semibold text-lg !text-white mb-2">2. Daytime Outfits</h5>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
                ...
                <div>
                  <h5 className="font-semibold text-lg !text-white mb-2">3. Evening & Early Morning</h5>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
                ...
                <div>
                  <h5 className="font-semibold text-lg !text-white mb-2">4. Footwear</h5>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
                ...
                <div>
                  <h5 className="font-semibold text-lg !text-white mb-2">5. Accessories</h5>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
              ...
              <p className="text-white leading-relaxed mt-6 italic drop-shadow-md">
            ...
            >
              ...
              <p className="text-white leading-relaxed mb-6 drop-shadow-md">
              ...
              <div className="space-y-5">
                <div>
                  <h4 className="text-xl font-semibold mb-2 !text-white">1. Luxury Lodges</h4>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 !text-white">2. Tented Camps</h4>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 !text-white">3. Mid-Range Lodges</h4>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 !text-white">4. Budget Camping</h4>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 !text-white">5. Kilimanjaro Mountain Camps</h4>
                  <p className="text-white mb-2">During a Kilimanjaro climb, accommodation is in tented camps along the routes.</p>
                  <ul className="list-disc list-inside text-white space-y-1 ml-2">
              ...
              <p className="text-white leading-relaxed mt-4 font-semibold drop-shadow-md">
            ...
            >
              ...
              <ol className="list-decimal list-inside text-white space-y-1 ml-2">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-6">
                <div>
                  <h4 className="text-lg font-semibold mb-2 !text-white">What's Included</h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2 !text-white">What's Not Included</h4>
                  <ul className="text-white space-y-1">
              ...
              <p className="text-white leading-relaxed mt-6 font-semibold drop-shadow-md">
            ...
            >
              ...
              <p className="text-white leading-relaxed mb-2 drop-shadow-md">
