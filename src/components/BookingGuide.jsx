...
const BookingGuide = () => {
  const textVariant = { hidden: { opacity: 0, x: -50 }, visible: { opacity: 1, x: 0, transition: { staggerChildren: 0.2, duration: 0.8 } } };
  const itemVariant = { hidden: { opacity: 0, x: -50 }, visible: { opacity: 1, x: 0, transition: { duration: 0.8 } } };
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-stretch gap-10 px-6 md:px-20">
        ...
        >
          ...
          <motion.div className="flex flex-wrap gap-4" variants={itemVariant}>
            <Button className="bg-[#D4AF37] text-[#3E2F1C] hover:bg-[#C49E2C]">Explore Trips</Button>
            <Button className="bg-[#3E2F1C] text-[#D4AF37] hover:bg-[#5A4B3A]">See Offers</Button>
          </motion.div>
        </motion.div>
