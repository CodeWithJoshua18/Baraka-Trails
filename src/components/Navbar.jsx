...
return ( <nav className="fixed top-0 left-0 right-0 z-50 pointer-events-auto">
<div
...
{/* Logo */}
<div className={`flex items-center gap-2 cursor-pointer ${textColor}`}> <Mountain className="w-8 h-8 text-[#D4AF37]" /> <span className="text-xl font-bold">Baraka Trails</span> </div>
  ...
  <div
    className={`fixed inset-0 z-40 flex flex-col items-center justify-center gap-8 backdrop-blur-xl bg-black/60 pointer-events-auto transition-all duration-500 ${
